...
import com.benhvien.Khamthai.service.RoleService;
...
public class RoleController {
	...
	@CrossOrigin(origins = "*", maxAge = 3600)
	public ResponseEntity<?> create(@RequestBody RoleModel role) {
		Map<String, Object> response = new HashMap<>();
		try {
			RoleModel data = roleService.create(role);
			response.put("data", data);
			response.put("success", true);
			response.put("message", "Ok");
			return new ResponseEntity<>(response, HttpStatus.OK);
	...
	@CrossOrigin(origins = "*", maxAge = 3600)
	public ResponseEntity<?> update(@RequestBody RoleModel role, @PathVariable(value = "id") String id) {
		Map<String, Object> response = new HashMap<>();
		try {
			RoleModel data = roleService.update(role, id);
			response.put("data", data);
			response.put("success", true);
